...
<head>
 <meta charset="utf-8" />
    <title>Trần Đông Blog - wwww.trandong.com</title>
...
{echo "<li><a href='http://localhost/webdemo/config/config.php'>Quản trị</a></li><li><a href='logout.php' onclick=' return logout()'>Đăng xuất</a></li>";}
else
...
<div class="search-form">
        ...
        <form id="searchform" method="get" action="http://localhost/luu_tru/">
...
<script type="text/javascript">
	...
	<div class="rightft"> 
		<h3>Địa chỉ: Thị Trấn Hồ, huyện Thuận Thành, tỉnh Bắc Ninh</h3>
	<h3>Số ĐT:1234567890</h3>
	<h3>Email:b1d5t36@gmail.com</h3>
	</div>
	</div>
</body>
</html>